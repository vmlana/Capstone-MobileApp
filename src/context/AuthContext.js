...
const tryLocalSignin = (dispatch) => async() => {
    ...
    token ? (dispatch({type: 'signin', payload: token}), navigate('HOME') :
    // ======================================
    navigate("ADD ROUTE NAME TO SignIn PAGE ")
    // ======================================
}
...
const signin = (dispatch) => async ({ email, password }) => {
  try {
      const response = await "ADD POST MEHOD like API.post('/signin, {email, password})"
...
const signout = (dispatch) => async() => {
    ...
    // ======================================
    navigate("ADD ROUTE NAME TO LOGIN PAGE")
    // ======================================
}
...
export const {Provider, Context } = createDataContext(
    authReducer,
    {tryLocalSignin, signin, signout, clearErrMsg }
)